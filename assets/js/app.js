...
const CW={
  ...
  competitors:{kw:['eastnets','fineksus','finiqe','dixio','competitor','better than','difference','why nxd','vs '],reply:'Fair question — here\'s an honest answer:<br><br><strong>EastNets</strong> has great products (SafeWatch is proven) but it\'s enterprise-scale: long implementations, high cost, and you adapt to their product. <strong>Fineksus</strong> has strong AML and messaging tools, particularly in Turkey. <strong>FiniQe</strong> is a consulting firm — no owned product IP. <strong>DiXiO</strong> is a SWIFT bureau — connectivity only.<br><br>NXD builds around your infrastructure. We don\'t have a product catalogue you must fit into. Most of our clients come to us after a vendor implementation stalled.<br><br>What specific capability are you comparing?'},
